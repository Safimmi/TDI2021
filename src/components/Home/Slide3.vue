<template>
    ...
    <div class="slide2">
        <div class="area">
            <h2 value="Verde">Ciencias de la Ingeniería</h2>
        </div>
        <div class="content">
            <p @click="cmate()">Programación I</p>
            <p @click="cdifer()">Programación II</p>
            <p @click="cintegral()">Programación III</p>
            <p @click="cvectorial()">Expresión gráfica</p>
            <p @click="cecuaciones()">Dibujo</p>
            <p @click="calgebra()">Introducción a la ingeniería</p>
            <p @click="cprob()">Metodología de la investigación</p>
            <p @click="cmetod()">Seminario de investigación</p>
        </div>
    </div>
