...
<div class="wrapper">
  ...
  <div class="salir">
    <button class="btn btn-primary btn-lg" style="background-color: #353755; border: none; border-radius: 30px;font-family: 'Montserrat', sans-serif; padding: 10px 25px; link-hover-color:#000" >Salir</button>
  </div>
  </div>
</template>
